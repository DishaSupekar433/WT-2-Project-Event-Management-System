        ...
        <div className="header">
            <div className={type === "list" ? "headerContainer listMode" : "headerContainer"}>
                ...
                {type !== "list" &&
                    <>
                        <br /><br></br>
                        <h1 className="headerTitle" > EventVitals </h1>
                        <p className="headerDesc">
                            Looking for assistance with event planning? We're here to help!
                            With our expert event planning and unique design expertise, we'll make your event truly spectacular!
                        </p>
